...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let athletes = Athlete::from_csv_path("C:\\Users\\john\\sandbox\\mdb\\fssl\\Athlete.csv".to_string());
    match athletes {
        Ok(data) => {
            println!("Loaded {} athletes", data.len());
    ...
    let results = RResult::from_csv_path("C:\\Users\\john\\sandbox\\mdb\\fssl\\Result.csv".to_string());
    match results {
        Ok(data) => {
            println!("Loaded {} athletes", data.len());
            // Process athletes data...
